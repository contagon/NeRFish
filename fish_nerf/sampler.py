...
class StratifiedRaysampler(torch.nn.Module):
    ...
    def forward(
        ...
        z_vals = torch.linspace(self.min_depth, self.max_depth, self.n_pts_per_ray).cuda()[:,None,None]
        ...
        return ray_bundle._replace(
            ...
            sample_lengths=z_vals.view(1,self.n_pts_per_ray,1) * torch.ones_like(sample_points[..., :1]),
        )
